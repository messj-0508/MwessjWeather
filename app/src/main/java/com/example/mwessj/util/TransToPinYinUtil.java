...
public class TransToPinYinUtil {
    ...
    private static TransToPinYinUtil chineseSpelling = new TransToPinYinUtil();

    public static TransToPinYinUtil getInstance() {
    ...
    public static String trans2PinYin(String str) {
        return TransToPinYinUtil.getInstance().convertAll(str);
    }
}
